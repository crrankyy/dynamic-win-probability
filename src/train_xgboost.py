"""
XGBoost Training Script for IPL Win Probability
- Loads configs from configs/xgboost.yaml
- Expanding-window temporal CV (3 folds)
- Saves best model to models/xgboost.pkl
"""
...
# ─── Main ─────────────────────────────────────────────────────────────
def main():
    config_path = os.path.join(PROJECT_ROOT, 'configs', 'xgboost.yaml')
